            ...
            <div class="card text-center h-100 shadow-sm">
              <div class="card-body d-flex flex-column">
                ...
                <div class="card-image mb-3" style="height: 180px; overflow: hidden; border-radius: 5px;">
                  <?php echo '<img src="./private/helpers/visualizar_imagen.php?local_id=' . $local['id'] . '" alt="Imagen de ' . htmlspecialchars($local['nombre']) . '" class="w-100 h-100" style="object-fit: cover;">'; ?>
                </div>
