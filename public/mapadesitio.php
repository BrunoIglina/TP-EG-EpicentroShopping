					...
					<div class="col-md-6 col-lg-5">
						<div class="card h-100 shadow-sm">
							<div class="card-header bg-primary text-white">
								<h3 class="mb-0">Navegación General</h3>
							</div>
							<div class="card-body">
						...
						<div class="card h-100 shadow-sm">
							...
							<div class="card-body">
								<ul class="list-unstyled mb-0">
									...
									<li class="mb-2"><a href="auth/recuperar-cuenta.php" class="text-decoration-none">Recuperar Cuenta</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<?php else: ?>
				<div class="row justify-content-center g-4 mb-5">
					<div class="col-md-4">
						<div class="card h-100 shadow-sm">
							<div class="card-header bg-primary text-white">
								<h3 class="mb-0" style="white-space: nowrap;">Navegación</h3>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mb-0">
									<li class="mb-2"><a href="index.php" class="text-decoration-none">Inicio</a></li>
							...
							<div class="card h-100 shadow-sm">
								...
								<div class="card-body">
									<ul class="list-unstyled mb-0">
										...
										<li class="mb-2"><a href="admin/promociones.php" class="text-decoration-none">Gestionar Promociones</a>
										</li>
										<li class="mb-2"><a href="admin/aprobar_duenos.php" class="text-decoration-none">Aprobar Dueños</a></li>
										<li class="mb-2"><a href="admin/aprobar_clientes.php" class="text-decoration-none">Aprobar Clientes</a>
										</li>
									</ul>
								</div>
							</div>
						<?php elseif ($user_tipo == 'Dueno'): ?>
							<div class="card h-100 shadow-sm">
								<div class="card-header bg-warning text-dark">
									<h3 class="mb-0">Panel de Dueño</h3>
								</div>
								<div class="card-body">
									<ul class="list-unstyled mb-0">
										<li class="mb-2"><a href="index.php?vista=dueno_promociones" class="text-decoration-none">Mis
												Promociones</a></li>
										<li class="mb-2"><a href="index.php?vista=dueno_promocion_agregar" class="text-decoration-none">Crear
												Promoción</a></li>
										<li class="mb-2"><a href="index.php?vista=dueno_solicitudes" class="text-decoration-none">Gestionar
												Solicitudes</a></li>
						...
						<?php elseif ($user_tipo == 'Cliente'): ?>
							<div class="card h-100 shadow-sm">
								<div class="card-header bg-info text-white">
									<h3 class="mb-0">Panel de Cliente</h3>
								</div>
								<div class="card-body">
									<ul class="list-unstyled mb-0">
										<li class="mb-2"><a href="index.php?vista=promocioness" class="text-decoration-none">Pedir Promoción</a>
										</li>
										<li class="mb-2"><a href="index.php?vista=cliente_promociones" class="text-decoration-none">Mis
												Solicitudes</a></li>
									</ul>
								</div>
							</div>
					...
					<div class="col-md-4">
						<div class="card h-100 shadow-sm">
							...
							<div class="card-body">
								<ul class="list-unstyled mb-0">
									<li class="mb-2"><a href="index.php?vista=cliente_perfil" class="text-decoration-none">Mi Perfil</a>
									</li>
									<li class="mb-2"><a href="index.php?vista=cliente_mod_perfil" class="text-decoration-none">Modificar
											Perfil</a></li>
				...
				<div class="col-12 col-lg-10">
					<div class="card shadow-sm">
						<div class="card-header bg-secondary text-white">
							<h3 class="mb-0">Ubicación - Epicentro Shopping</h3>
						</div>
						<div class="card-body p-0">
							<div class="map-container">
								<iframe
									src="https://www.openstreetmap.org/export/embed.html?bbox=-60.62850773334504%2C-32.960718554326746%2C-60.62496721744538%2C-32.95877410891247&amp;layer=mapnik&amp;marker=-32.95974633696806%2C-60.6267374753952"
									style="border: 0; width: 100%; height: 400px;"></iframe>
							</div>
						</div>
						<div class="card-footer text-center">
							<small><a
									href="https://www.openstreetmap.org/?mlat=-32.959746&amp;mlon=-60.626737#map=19/-32.959746/-60.626737"
									target="_blank" class="text-decoration-none">Ver el mapa más grande</a></small>
						</div>
					</div>
				</div>
			</div>
