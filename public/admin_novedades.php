                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($novedad['imagen'])): ?>
                                                <img src="../private/logic/helpers/visualizar_imagen.php?novedad_id=<?php echo $novedad['id']; ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm" action="../private/logic/crud/novedades.php" method="post" style="display: inline;">
