    ...
    <div class="wrapper">
        ...
        <main class="container-fluid">
            ...
            <div class="admin-section">
                ...
                <?php if (!$locales) { ?>
                    <div class="alert alert-warning" role="alert">No hay locales cargados</div>
                <?php } else { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($local['imagen'])) { ?>
                                                <img src="index.php?vista=imagen&local_id=<?php echo $local['id']; ?>" 
                                                     alt="Logo del local <?php echo htmlspecialchars($local['nombre']); ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title h5" id="confirmModalLabel">Confirmar Acción</h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h3 class="modal-title h5" id="errorModalLabel">No se puede generar el PDF</h3>
