        ...
        <div class="col-lg-6 col-md-8">
          <div class="form-card">
            ...
            <div class="alert alert-danger alert-dismissible fade show">
              <?php echo htmlspecialchars($_SESSION['mensaje_error1']);
            ...
            <form action="router.php" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="entidad" value="locales">
              ...
              <div class="mb-4">
                ...
                <input type="file" class="form-control" id="imagen_local" name="imagen_local" accept=".png, .jpeg, .jpg"
                  required>
              </div>
