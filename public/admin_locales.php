...
<body>
    ...
    <?php include '../private/get_all_locales.php'; ?>
    <main>
        <section class="admin-section">
            ...
            <form id="localesForm" method="POST" action="../private/procesar_local.php">
                ...
                <table>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result_locales)) { ?>
                            <tr>
                                <td><input type="checkbox" name="locales[]" value="<?php echo $row['id']; ?>" <?php echo (isset($_GET['select_all']) && $_GET['select_all'] == '1') ? 'checked' : ''; ?>></td>
