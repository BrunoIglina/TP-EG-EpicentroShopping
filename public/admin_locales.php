                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($local['imagen'])) { ?>
                                                <img src="../private/logic/helpers/visualizar_imagen.php?local_id=<?php echo $local['id']; ?>" alt="Imagen del local" class="img-fluid" style="max-width: 100px;">
                                            <?php } else {
                                                echo "No hay imagen";
                                            } ?>
                                        </td>
        ...
        function confirmAction(action, localId) {
            ...
            $('#confirmActionBtn').off('click').on('click', function() {
                if (action === 'edit') {
                    ...
                    window.location.href = './private/logic/crud/locales.php?action=delete&local_id=' + localId;
                }
            });
        }
