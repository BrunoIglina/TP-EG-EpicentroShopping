...
<body>
					...
					<?php foreach ($solicitudes as $row): ?>
						<div class="col-md-4 mb-4">
							<div class="card h-100">
								<div class="card-body">
									<h3 class="card-title"><?php echo htmlspecialchars($row["local_nombre"]); ?></h3>
									...
									<?php if ($row["estado"] == 'enviada'): ?>
										<div class="d-flex justify-content-between mt-3">
											<button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#confirmModal"
												data-promo-id="<?php echo $row["idPromocion"]; ?>" data-cliente-id="<?php echo $row["idCliente"]; ?>"
												data-accion="aceptar" data-email="<?php echo htmlspecialchars($row["email"]); ?>">
												Aceptar
											</button>
											<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmModal"
												data-promo-id="<?php echo $row["idPromocion"]; ?>" data-cliente-id="<?php echo $row["idCliente"]; ?>"
												data-accion="rechazar" data-email="<?php echo htmlspecialchars($row["email"]); ?>">
												Rechazar
											</button>
										</div>
									<?php endif; ?>
	...
	<div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
