                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-select" id="local_id" name="local_id">
                                ...
                                <?php foreach ($locales_dueno as $local): ?>
                                    <option value="<?php echo $local['id']; ?>" <?php echo ($local_id == $local['id']) ? 'selected' : ''; ?>>
                            ...
                            <?php if (count($reportes) > 0): ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><span class="badge <?php echo $estadoClass; ?>"><?php echo htmlspecialchars($row['estadoPromo']); ?></span></td>
